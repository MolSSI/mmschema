...
ForceField = {
    ...
    "properties": {
        ...
        "nonbonded": {
            ...
            "anyOf": [
                {"type": "object", "$ref": "#/definitions/NonBonded"},
                {"type": "array", "items": {"$ref": "#/definitions/NonBonded"}},
            ],
        },
        "bonds": {
            "title": "Bonds",
            ...
            "anyOf": [
                {"type": "object", "$ref": "#/definitions/Bonds"},
                {"type": "array", "items": {"$ref": "#/definitions/Bonds"}},
            ],
        },
        "angles": {
            "title": "Angles",
            ...
            "anyOf": [
                ...
                {"type": "array", "items": {"$ref": "#/definitions/Angles"}},
            ],
        },
        "dihedrals": {
            "title": "Dihedrals",
            ...
            "anyOf": [
                ...
                {"type": "array", "items": {"$ref": "#/definitions/Dihedrals"}},
            ],
        },
        "charges": {
            "title": "Charges",
    ...
    "definitions": {
        ...
        "Bonds": {
            ...
            "required": ["form", "params", "lengths", "indices"],
            "additionalProperties": False,
        },
        "Angles": {
            "title": "Angles",
            ...
            "required": ["form", "params", "angles", "indices"],
            "additionalProperties": False,
        },
        "Dihedrals": {
            "title": "Dihedrals",
